...
//import WithdrawFunds from "./componenets/withdrawFunds";
...
function App() {
  ...
  useEffect(() => {
    const template = async () => {
      const contractAddress = "0xfC33A59A91633f4a90501f9a44B2707654FdfbF2";
  ...
  return (
    <div style={{ backgroundColor: "#000000", height: "100%" }}>
      ...
      {/*<WithdrawFunds state={state}></WithdrawFunds> */}
    </div>
  );
}
